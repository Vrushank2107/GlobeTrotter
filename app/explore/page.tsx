    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="pl-0 md:pl-72 flex-1 flex flex-col min-w-0">
        ...
        <main className="pt-20 md:pt-24 pb-24 md:pb-16 px-4 md:px-10 min-h-screen">
          {/* Hero Banner */}
          <div className="mb-6 md:mb-8 bg-slate-900 text-white rounded-3xl p-4 md:p-8 shadow-md relative overflow-hidden">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-5 mb-6 shadow-xs flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-3 w-full md:w-auto">
              <div className="flex items-center gap-1 md:gap-1.5 flex-1 md:flex-initial">
                <span className="text-[10px] md:text-xs text-slate-500 font-semibold uppercase tracking-wider">Country:</span>
                <select
                  value={selectedCountry}
                  onChange={(e) => setSelectedCountry(e.target.value)}
                  className="bg-slate-50 border border-slate-200 rounded-xl px-2 md:px-3 py-2 text-[10px] md:text-xs font-semibold outline-none focus:border-sky-500"
                >
                  {countriesList.map((c) => (
              ...
              <div className="flex items-center gap-1 md:gap-1.5 flex-1 md:flex-initial">
                <span className="text-[10px] md:text-xs text-slate-500 font-semibold uppercase tracking-wider">Region:</span>
                <select
