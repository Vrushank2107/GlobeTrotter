...
export const tripDetailsSchema = z.object({
  ...
  travelers: z.number().min(1, 'At least 1 traveler required').optional().default(1),
...
export const updateTripSchema = tripDetailsSchema.partial().extend({
  status: z.enum(['planning', 'confirmed', 'completed', 'cancelled', 'Planning', 'Confirmed', 'Completed']).optional(),
});
