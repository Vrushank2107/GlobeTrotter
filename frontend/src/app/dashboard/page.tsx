...
export default function DashboardPage() {
  const { user, trips, searchQuery, setActiveTripId } = useTripContext();
              ...
              <div className="col-span-12 lg:col-span-8 flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div className="bg-white border border-slate-200/80 rounded-2xl p-6 flex items-center gap-4 shadow-xs hover:shadow-md transition-all hover:-translate-y-0.5">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-slate-900">{user.countriesVisited}</p>
              ...
              <div className="col-span-12 lg:col-span-4">
                <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs h-full">
                  <h2 className="text-lg font-bold text-slate-900 mb-6 flex items-center justify-between">
                    ...
                    <span className="text-xs text-sky-600 font-normal">Live Sync</span>
                  </h2>
                  ...
                  <div className="relative pl-6 space-y-6">
                    ...
                    <div className="relative">
                      ...
                      <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100 text-xs">
                        <span className="text-slate-400 font-medium block mb-1">2 hours ago</span>
                        <p className="text-slate-700">
                          Added <span className="font-semibold text-sky-600">Shibuya Crossing</span> to Japan itinerary.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100 text-xs">
                        <span className="text-slate-400 font-medium block mb-1">Yesterday</span>
                        <p className="text-slate-700">
                          Logged <span className="font-semibold text-slate-900">₹15,000</span> hotel expense for Goa Getaway.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100 text-xs">
                        <span className="text-slate-400 font-medium block mb-1">3 days ago</span>
                        <p className="text-slate-700">
                          Confirmed dates for <span className="font-semibold text-indigo-600">Southern Soul Search</span> trip.
                        </p>
                      </div>
                    </div>
                  </div>
